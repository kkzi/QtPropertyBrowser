...
QtListPropertyBrowser* ListPropertyWidget::browser() const
{
	return browser_;
}

QtVariantPropertyManager* ListPropertyWidget::manager() const
{
	return manager_;
}

QtVariantEditorFactory* ListPropertyWidget::factory() const
{
	return factory_;
}
